...
const url = process.env.DB_HOST_EXTERNAL
            ...
            <html>
              ...
              <body>
                <div>
                  ...
                  <button className="btn btn-primary rounded"><a href="${url}:${port}/patients/update-password/${dni}/${temporalToken}">CLICK AQUI</a></button>
