...
function createDefaultAdmin(pool) {
  ...
  bcrypt.hash(password, 10, async (err, hash) => {
    ...
    const query =
      "INSERT INTO clinic.employees (firstname, lastname, phone, sex, email, address, birthday, dni, specialist, personalID, days_off, start_time, end_time, password ) VALUES ('admin', 'adminLastname', 11111111, 'H', 'admin@gmail.com', 'admin 123','2024/01/01', '789345123', 'admin', 'admin', '[0,0]', 9, 17, '" +
      hash +
      "')";
