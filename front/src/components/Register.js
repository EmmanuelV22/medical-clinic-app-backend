...
const Register = () => {
  ...
  function  changeEmployee ()  {
    employeeForm === "block" ? setEmployeeForm("none") : setEmployeeForm("block");
    buttonText === "Switch to register a patient" ? setButtonText("Switch to register an employee") : setButtonText("Switch to register a patient");
...
console.log(request)
  ...
  return (
    <>
    <button className="btn btn-success" onClick={changeEmployee}> {buttonText}</button>
    <div style={{display: employeeForm}} className="w-full max-w-xs">
      ...
      className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <div className="mb-6">
          ...
          />
          {password === "" ? <p className="text-red-500 text-xs italic">
