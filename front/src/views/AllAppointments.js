        ...
        {allFilter.length > 0 ? (
          allFilter.map((data) => (
            <tr key={data.id}>
              ...
              <td className="table-lastname">{data.patient?.lastname}</td>
              <td className="table-dni">{data.patient?.dni}</td>
              <td className="table-phone">{data.patient?.phone}</td>
              <td className="separate-table-dr">{data.employee?.firstname}</td>
              <td className="table-name-dr">{data.employee?.lastname}</td>
              <td className="separate-table-appointment">{data.employee?.specialist}</td>
              <td className="table-turno">{data.date}/{data.month}/{data.year}</td>
